    ...
    return (
        <div className="aboutMe" id="aboutMe">
            <div className="aboutMeText">
                ...
                <p>I am in my first term of the program. Prior to enrolling, I spent three years studying the Information Technology program at NTI Södertörn, where i also studied a technical base year (TE4).</p>
                <p>
